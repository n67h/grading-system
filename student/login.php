    ...
    <?php
        if(isset($_POST['login'])){
            ...
            if($checkPassword === false) {
                ...
                $query = "SELECT * FROM tbl_student WHERE student_id = '" .$emailExists['student_id']. "' AND email = '" .$emailExists['email']. "';";
                $result = mysqli_query($conn, $query);
                $count = mysqli_num_rows($result);
                if($count === 1) {    
                    session_start();
                    $_SESSION['student_id'] = $emailExists['student_id'];
                    $_SESSION['year_level_id'] = $emailExists['year_level_id'];
                    $_SESSION['student_lrn'] = $emailExists['student_lrn'];
        ...
        <div class="row content d-flex justify-content-center align-items-center">
            <div class="col-md-5">
                <div class="box shadow bg-white p-4">
                    <h6 class="mb-4 text-center fs-1">Student Login</h6>
