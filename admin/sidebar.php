    ...
    <div class="main-container d-flex">
        ...
        <div class="sidebar" id="sidebar">
            <div class="header-box px-2 pt-3 pb-2 d-flex justify-content-between">
                <h1 class="fs-4"><a href="dashboard.php" class="text-decoration-none"><span class="bg-dark text-white rounded shadow px-2 me-2 p-1">JCMPHS</span><span class="text-dark">Admin</span></a></h1>
                       
                <button class="btn d-md-none d-block close-btn px-1 py-0 text-dark"><i class="fa-solid fa-bars-staggered"></i></button>
            </div>
            ...
            <ul class="list-unstyled px-2">
                <div class="d-flex mt-1 ps-2 pb-1">
                    <?php
                        if(isset($_SESSION['admin_id'])){
                            $sql = "SELECT * FROM tbl_admin WHERE admin_id = $admin_id_session;";
                            ...
                            if(mysqli_num_rows($result) > 0){
                                ...
                                echo '<img class="text-white rounded-circle" src="../assets/images/admin-icon.png" alt="" style="width: 20%; height: 30%;">';
                ...
                <li class=""><a href="student.php?grade=7" class="text-decoration-none px-3 py-2 d-block text-dark"><i class="fa-solid fa-user"></i> Student</a></li>
