...
<body>
    <?php
        if(isset($_POST['login'])){
            ...
            $checkPassword = $usernameExists["password"];
            ...
            if($checkPassword !== $password) {
                ...
                $query = "SELECT * FROM tbl_admin WHERE admin_id = '" .$usernameExists['admin_id']. "' AND username = '" .$usernameExists['username']. "';";
                $result = mysqli_query($conn, $query);
                $count = mysqli_num_rows($result);
                if($count === 1) {    
                    session_start();
                    $_SESSION['admin_id'] = $usernameExists['admin_id'];
        ...
        <div class="row content d-flex justify-content-center align-items-center">
            <div class="col-md-5">
                <div class="box shadow bg-white p-4">
                    <h6 class="mb-4 text-center fs-1">Admin Login</h6>
